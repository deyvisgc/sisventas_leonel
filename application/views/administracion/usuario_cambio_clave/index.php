										...
										<div class="row">
											...
											<form class="form-horizontal" id="fm_usuario">
												<div class="form-group">
													<label for="in_usu_clave" class="col-sm-2 control-label">CLAVE ACTUAL</label>
													<div class="col-sm-3">
												...
												<div class="form-group">
													...
													<div class="col-sm-3">
														<button type="button" class="btn btn-primary" onclick="func_cambiar_clave(event);" id="btn-altas"><i class="fa fa-check-circle"></i> Cambiar clave</button>
													</div>
												</div>
											</form>
										</div>
