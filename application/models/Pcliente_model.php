...
class Pcliente_model extends CI_Model {
	...
	function Buscar_compras_provedor($pcl_id_pcliente){
		$sql="SELECT ing.ing_id_ingreso,ing.ing_monto,DATE_FORMAT(ing.ing_fecha_doc_proveedor,'%d-%m-%Y') as ing_fecha_doc_proveedor FROM ingreso as ing ,pcliente as pc WHERE
