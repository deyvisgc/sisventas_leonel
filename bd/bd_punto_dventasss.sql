...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 17-01-2019 a las 05:20:18
...
--
-- Base de datos: `bd_punto_dventasss`
--
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `proc_temp_salida_agregar` (OUT `out_hecho` VARCHAR(2), OUT `out_estado` VARCHAR(7), IN `in_usu_id_usuario` INT, IN `in_pro_id_producto` INT, IN `in_cantidad` DOUBLE(15,2), IN `in_precio` DOUBLE(15,3), IN `in_ganancias` DOUBLE(15,2), IN `in_kilogramos` DOUBLE(15,2))  cuerpo: BEGIN
    DECLARE var_pro_cantidad DOUBLE(15,2);
...
(19, '180810172243', 67, 69, 'AFRECHO X 40', 26.80, 32.00, 53.00, 10.00, 2, 'http://localhost/boletas.php/../resources/sy_file_repository/img_vacio.png', 'NO', NULL, 5.00, 0.273, 8.00, 0.374, 9.00, 0.386, 0.00, 11, 'NO', 20.00),
...
(22, '180823165028', 67, 69, 'AFRECHO X 30', 22.80, 25.00, 416.00, 20.00, 2, 'http://localhost/boletas.php/../resources/sy_file_repository/img_vacio.png', 'NO', NULL, 0.00, 0.000, 0.00, 0.000, 0.00, 0.000, 0.00, 11, 'NO', 0.00),
(23, '180823172439', 67, 69, 'CONEJO COGORNO X 40', 57.60, 62.00, 422.00, 20.00, 2, 'http://localhost/boletas.php/../resources/sy_file_repository/img_vacio.png', 'NO', NULL, 0.00, 0.000, 0.00, 0.000, 0.00, 0.000, 0.00, 11, 'NO', 0.00),
...
(26, '180823172803', 67, 69, 'CONEJO B12 X 40', 65.80, 70.00, 7.00, 20.00, 2, 'http://localhost/boletas.php/../resources/sy_file_repository/img_vacio.png', 'NO', NULL, 0.00, 0.000, 0.00, 0.000, 0.00, 0.000, 0.00, 11, 'NO', 0.00),
...
(44, '180827182515', 67, 69, 'CONEJO OSCAR X 40', 38.00, 40.00, 165.00, 15.00, 2, 'http://localhost/boletas.php/../resources/sy_file_repository/img_vacio.png', 'NO', NULL, 0.00, 0.000, 0.00, 0.000, 0.00, 0.000, 0.00, 11, 'NO', 0.00),
...
(73, '180920094655', 67, 69, '2H X 50', 41.96, 75.00, 3.00, 3.00, 2, '', 'SI', NULL, 0.00, 0.000, 0.00, 0.000, 0.00, 0.000, 0.00, 11, 'NO', 0.00),
...
(89, '180925175629', 84, 86, 'BABYCAN ADULTO VERDE', 64.00, 68.00, 44.00, 2.00, 2, '', 'SI', NULL, 0.00, 0.000, 0.00, 0.000, 0.00, 0.000, 0.00, 11, 'NO', 0.00),
...
(111, '181005164534', 82, 83, 'CONCHUELA GRUESA', 25.00, 28.00, 122.00, 10.00, 2, '', 'SI', NULL, 0.00, 0.000, 0.00, 0.000, 0.00, 0.000, 0.00, 11, 'NO', 0.00),
...
(118, '181005165721', 82, 83, 'ALFALFA', 66.00, 66.00, 25.00, 10.00, 2, '', 'SI', NULL, 0.00, 0.000, 0.00, 0.000, 0.00, 0.000, 0.00, 11, 'NO', 0.00),
...
(19, 152.52, '2019-01-14', 'retiro', 'asd', 1801, 3),
(20, 480.00, '2019-01-14', 'retiro', 'Helo as dnajs ajsdnaj ajsda', 1801, 3);
...
CREATE TABLE `temp` (
  ...
  `temp_valor` double(15,3) DEFAULT '0.000',
...
(3, 'soporte', '$2y$12$Ybi.Bevhd6AQPuLdG2.SF.q9yHSYP073MKW1lyOap8Uc5krnVVKOm', 2, 11),
...
--
ALTER TABLE `ingreso`
  MODIFY `ing_id_ingreso` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;

--
-- AUTO_INCREMENT de la tabla `ingreso_detalle`
--
ALTER TABLE `ingreso_detalle`
  MODIFY `ind_id_ingreso_detalle` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=24;

--
-- AUTO_INCREMENT de la tabla `movimiento`
--
ALTER TABLE `movimiento`
  MODIFY `mov_id_movimiento` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3004;
...
--
ALTER TABLE `salida`
  MODIFY `sal_id_salida` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=598;

--
-- AUTO_INCREMENT de la tabla `salida_detalle`
--
ALTER TABLE `salida_detalle`
  MODIFY `sad_id_salida_detalle` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2281;

--
-- AUTO_INCREMENT de la tabla `sangria`
--
ALTER TABLE `sangria`
  MODIFY `id_sangria` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=21;
